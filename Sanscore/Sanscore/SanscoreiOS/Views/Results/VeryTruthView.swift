...
struct VeryTruthView: View {
    ...
    /// TODO(pafras): pass the peak HR, e.g. VeryTruthView(peakBPM: vm.peakBPM)
    var peakBPM: Int? = 120
            ...
            VStack(spacing: 12) {
                ...
                HStack(spacing: 0) {
                    ...
                    Button(action: onReady) {
                        ZStack {
                            Image(iAmReady ? "player-placeholder-inactive-2"
                                           : "player-placeholder-active-2")
                                .resizable()
                                .scaledToFit()
                                .frame(height: 76)
    ...
    private func runIntro() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5) {
            ...
            Haptics.notify(.success)   // strong truth verdict
        }
